          ...
          <div class="trunfo-footer">
            ...
            <div class="like-container">
              ...
              <button id="heart-btn-${idNormalizado}" class="heart-btn ${isLiked ? "liked" : ""}" onclick="toggleCurtida(event, '${idNormalizado}')">
                <svg class="heart-svg" viewBox="0 0 9 8" xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges">
                  <!-- Coração pixel-art 8-bit — grade 9×8px -->
                  <rect x="1" y="0" width="2" height="1"/><rect x="6" y="0" width="2" height="1"/>
                  <rect x="0" y="1" width="4" height="1"/><rect x="5" y="1" width="4" height="1"/>
